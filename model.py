...
import Couplet.seq2seq
import Couplet.bleu
import Couplet.reader
from os import path
import random

from Couplet import reader, seq2seq
...
class Model():
    ...
    def _init_train(self):
        ...
        with self.train_graph.as_default():
            ...
            tf.summary.scalar('map.txt', self.loss)
        ...
        with self.train_graph.as_default():
            ...
            for step in range(start, epochs):
                ...
                if step % self.save_step == 0:
                    ...
                    print("Saving model. Step: %d, map.txt: %f" % (step,
                ...
                if step % self.eval_step == 0:
                    ...
                    print("Evaluate model. Step: %d, score: %f, map.txt: %f" % (
